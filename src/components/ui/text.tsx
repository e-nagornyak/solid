...
const textVariants = cva("", {
  variants: {
    size: {
      xxs: "text-[11px]", // font-size: 10px, line-height: 13px
      xs: "text-[12px]", // font-size: 12px, line-height: 16px
      sm: "text-[14px]", // font-size: 14px, line-height: 20px
      base: "text-[16px]", // font-size: 16px, line-height: 24px
      lg: "text-[18px]", // font-size: 18px, line-height: 28px
      xl: "text-[20px]", // font-size: 20px, line-height: 28px
      "2xl": "text-[24px]", // font-size: 24px, line-height: 32px
      "3xl": "text-[30px]", // font-size: 30px, line-height: 36px
      "4xl": "text-[36px]", // font-size: 36px, line-height: 40px
      "5xl": "text-[48px]", // font-size: 48px, line-height: 1
      "6xl": "text-[60px]", // font-size: 60px, line-height: 1
      "7xl": "text-[72px]", // font-size: 72px, line-height: 1
      "8xl": "text-[96px]", // font-size: 96px, line-height: 1
      "9xl": "text-[128px]", // font-size: 128px, line-height: 1
    },
    weight: {
    ...
    color: {
      default: "text-c-gray",
      "gray-50": "text-c-gray-50",
      "gray-200": "text-c-gray-200",
      "gray-300": "text-c-gray-300",
    },
  },
  defaultVariants: {
    color: "default",
